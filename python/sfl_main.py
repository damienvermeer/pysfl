...
sf_settings['general/azimuth/tolerance/steps'] = 10 #number of steps to iterate over for azimuth
...
sf_settings['general/row/setback/steps'] = 10 #number of steps to iterate over for setback
...
sf_settings['plot/best'] = 3  #top XX to plot, or -1 to plot all
